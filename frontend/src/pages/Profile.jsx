...
import { MapPin, Calendar, Edit3, ArrowRightLeft, Star, Clock, Loader2, AlertCircle, FileText, Trash2 } from 'lucide-react';
...
export default function Profile() {
  ...
  const avatarUrl = `https://ui-avatars.com/api/?name=${encodeURIComponent(userName)}&background=6366f1&color=fff&size=200`;
  ...
  return (
    <PageWrapper>
      <div className="flex flex-col w-full min-h-screen relative z-10 -mt-10">
        ...
        {/* Bio Section (Desktop - shown below header if bio exists) */}
        {userBio && (
