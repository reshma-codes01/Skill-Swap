...
export default function HeroSection({ onLoginClick }) {
  ...
  return (
    <section className="pt-32 pb-20 lg:pt-40 lg:pb-28 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto z-10 relative">
        ...
        <div className="flex flex-col items-center text-center lg:items-start lg:text-left space-y-8">
          ...
          >
            <button
              ...
              className="w-full sm:w-auto px-8 py-4 text-center text-lg font-medium rounded-full bg-zinc-900 dark:bg-zinc-100 text-white dark:text-zinc-950 hover:bg-zinc-800 dark:hover:bg-white hover:scale-105 transition-all duration-300 shadow-lg shadow-zinc-900/20 dark:shadow-none focus:outline-none"
            >
              Start Swapping
            </button>
            <Link
              to="/explore"
              className="w-full sm:w-auto px-8 py-4 text-center text-lg font-medium rounded-full bg-white/70 dark:bg-zinc-900/50 backdrop-blur-md border border-zinc-200 dark:border-zinc-800 text-zinc-700 dark:text-zinc-300 hover:bg-zinc-50 dark:hover:bg-zinc-800 transition-colors duration-300 shadow-sm"
            >
              Explore Network
            </Link>
          </motion.div>
